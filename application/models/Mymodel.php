...
class Mymodel extends CI_Model {
	...
	function get_view1($dated)
	{
		$this->load->database();
		$query=$this->db->query("select * from timeline where id='1' ");	
		
		return $query->result();
	}
	
	function get_view2($dated)
	{
		$this->load->database();
		$query=$this->db->query("select * from timeline where id='2'");	
		
		return $query->result();
	}
	
	function get_view3($dated)
	{
		$this->load->database();
		$query=$this->db->query("select * from timeline where id='3'");	
		
		return $query->result();
	}
	function get_view4($dated)
	{
		$this->load->database();
		$query=$this->db->query("select * from timeline where id='4'");	
		
		return $query->result();
	}
	function get_view5($dated)
	{
		$this->load->database();
		$query=$this->db->query("select * from timeline where id='5' ");	
		
		return $query->result();
	}
	
	function get_view6($dated)
	{
		$this->load->database();
		$query=$this->db->query("select * from timeline where id='6'");	
		
		return $query->result();
	}
	
	function get_view7($dated)
	{
		$this->load->database();
		$query=$this->db->query("select * from timeline where id='7'");	
		
		return $query->result();
	}
	function get_view8($dated)
	{
		$this->load->database();
		$query=$this->db->query("select * from timeline where id='8'");	
