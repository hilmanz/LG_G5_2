            ...
            <section id="welcome" class="section swatch-red-white">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <img src="<?=base_url();?>/assets/images/games/LG-360_cam.png" class="img-responsive center-block" style="padding-top:-120px">
                    </div>
                    ...
                    <div class="col-md-11 col-md-offset-2">
                        <div class="row text-center">
                            <div class="col-md-2 col-sm-3">
                                <a href="javascript:void(0)" class="btn btn-game" onclick="wrongChoose1();" id="choose1" alt="Yes/No">One-hand grip design<br>in motion</a>
                            </div>
                            <div class="col-md-2 col-sm-3">
                                <a href="javascript:void(0)" class="btn btn-game" onclick="wrongChoose2();" id="choose2" alt="Yes/No">FHD recording with<br>8 MP camera</a>
                            </div>
                            <div class="col-md-2 col-sm-3">
                                <a href="javascript:void(0)" class="btn btn-game" onclick="rightChoose1();" id="choose3" alt="Yes/No">One-touch 360 <br>photo &amp; video</a>
                            </div>
                            <div class="col-md-2 col-sm-3">
                                <a href="javascript:void(0)" class="btn btn-game" onclick="rightChoose2();" id="choose4" alt="Yes/No">5,1Ch sound &amp; QHD  <br>video recording</a>
                            </div>
                        </div>
                    </div>    
                </div>
...
$('.msg_error').html('');
	...
	function rightChoose2 () {
		...
		var answr2= $("#choose4").attr('alt');
		if((answr1=="Yes") && (answr2=="Yes")){
			window.location = basedomain+"form";
		}
		rules();
    }
	...
	function rules (){
		...
		var answr2= $("#choose2").attr('alt');
		var answr3= $("#choose4").attr('alt');//yes
