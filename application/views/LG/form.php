            ...
            <section id="welcome" class="section swatch-red-white">
                ...
                <div class="container">
                    <header class="section-header no-underline" style="margin-bottom:0 !important">
                        ...
                        <h2  style="color:#6c6d6f">Kamu telah berhasil mencocokkan LG G5 &amp; Friends! <br>Silakan isi data di bawah ini dan kunjungi LG Store sekarang untuk rasakan pengalaman seru bersama LG G5 & Friends!</h2>
