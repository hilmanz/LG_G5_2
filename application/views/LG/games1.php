<div id="content" role="main">
            <section id="welcome" class="section swatch-red-white">
                ...
                <header class="section-header no-underline" style="margin-bottom:0 !important">
                    ...
                    <h2  style="color:#6c6d6f">Tahukah kamu tentang manfaat dari G5 Friends? Pilih <span class="color:#404041">2 jawaban yang benar.</span></h2>
                    <p class="bold">01<span style="color:#9fa700">/04</span></p>
                </header>

                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <img src="<?=base_url();?>/assets/images/games/LG-rolling-bot.png" class="img-responsive center-block" style="padding-top:-120px">
                    </div>
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <div class="row text-center">
                            <div class="col-md-3 col-sm-3">
                                <a href="javascript:void(0)" class="btn btn-game" onclick="wrongChoose1();" id="choose1" alt="Yes/No">One-touch<br>360 photo &amp; video</a>
                            </div>
                            <div class="col-md-3 col-sm-3">
                                <!--a href="javascript:void(0)" class="btn btn-game-selected">The robot-of-choice<br>at the moment</a-->
								<a href="javascript:void(0)" class="btn btn-game" onclick="rightChoose1();" id="choose2" alt="Yes/No">The robot-of-choice<br>at the moment</a>
                            </div>
                            <div class="col-md-3 col-sm-3">
                                <!--a href="javascript:void(0)" class="btn btn-game-selected">Pet care -<br>Laser pointer, spinning</a-->
								<a href="javascript:void(0)" class="btn btn-game" onclick="rightChoose2();" id="choose3" alt="Yes/No">Pet care -<br>Laser pointer, spinning</a>
                            </div>
                            <div class="col-md-3 col-sm-3">
                                <a href="javascript:void(0)" class="btn btn-game" onclick="wrongChoose2();" id="choose4" alt="Yes/No">Easy to access<br>shutter &amp; zoom button</a>
                            </div>
                        </div>
                    </div>    
                </div>			
