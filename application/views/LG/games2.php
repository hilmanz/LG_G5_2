            ...
            <section id="welcome" class="section swatch-red-white">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <img src="<?=base_url();?>/assets/images/games/LG-HIFI-Plus.png" class="img-responsive center-block" style="padding-top:-120px">
                    </div>
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <div class="row text-center">
                            <div class="col-md-3 col-sm-3">
                                <a href="javascript:void(0)" class="btn btn-game" onclick="rightChoose1();" id="choose1" alt="Yes/No">Portable Hi-Fi <br>DAC amplifier</a>
                            </div>
                            <div class="col-md-3 col-sm-3">
                                <a href="javascript:void(0)" class="btn btn-game" onclick="wrongChoose1();" id="choose2" alt="Yes/No">Extended battery<br>(1200 mph) </a>
                            </div>
                            <div class="col-md-3 col-sm-3">
                                <a href="javascript:void(0)" class="btn btn-game" onclick="rightChoose2();" id="choose3" alt="Yes/No">LG Tone Platinum<br>(32 bit Hi-Fi Sound)</a>
                            </div>
                            <div class="col-md-3 col-sm-3">
                                <a href="javascript:void(0)" class="btn btn-game" onclick="wrongChoose2();" id="choose4" alt="Yes/No">One-hand grip design <br>in motion</a>
                            </div>
                        </div>
                    </div>    
                </div>
...
$('.msg_error').html('');
	...
	function rightChoose1 () {
		...
		if((answr1=="Yes") && (answr2=="Yes")){			
			window.location = basedomain+"games-3";
		}
		rules();
    }
