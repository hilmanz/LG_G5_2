...
// Switcher
    jQuery('#show-countdown .demo-icon').click(function() {
        console.log(1);
        if (jQuery('.show-countdown').hasClass("active")) {
            jQuery('.show-countdown').animate({
                "left": "-230px"
            }, function() {
                jQuery('.show-countdown').toggleClass("active");
            });
        } else {
            jQuery('.show-countdown').animate({
                "left": "0px"
    ...
    var btnWide = $('#show-countdown #btn-wide');
    var btnBoxed = $('#show-countdown #btn-boxed');
